...
#creates summaries of pahsing data across four categories by cancer type
def analyze_phasing_amongst_mutations_in_cancer_type(cancerTypeIds, maf, phasingData, cancerType):
    ...
    tumorSupressors = set(['ERRFI1', 'ASXL2', 'PMAIP1', 'ACTG1', 'SUFU', 'FBXO11', 'MEN1', 'FAM58A', 'B2M', 'RB1', 'DUSP22', 'SESN1', 'GPS2', 'RAD51D', 'SMG1', 'CDC73', 'MAP3K1', 'SMARCB1', 'INPP4B', 'PARK2', 'SMAD4', 'CBFB', 'CDH1', 'PPP6C', 'SETDB1', 'SETDB2', 'NF2', 'CDKN2B', 'CDKN2C', 'CDKN2A', 'DDX3X', 'PIK3R1', 'BARD1', 'PDS5B', 'KLF4', 'SPRED1', 'VHL', 'SMAD2', 'PMS1', 'PMS2', 'SETD2', 'GATA3', 'TBL1XR1', 'MUTYH', 'SOCS1', 'FAM175A', 'ROBO1', 'ARID1B', 'ARID1A', 'TCF7L2', 'STK11', 'FOXA1', 'PTEN', 'FAT1', 'FAS', 'CYLD', 'MAX', 'SH2D1A', 'APC', 'NTHL1', 'CTCF', 'KDM5C', 'KMT2C', 'ZFHX3', 'FOXP1', 'PIGA', 'CDKN1B', 'CDKN1A', 'FUBP1', 'MSH2', 'ID3', 'TNFRSF14', 'TRAF3', 'EP400', 'BRIP1', 'ARID4A', 'ARID4B', 'XRCC2', 'DAXX', 'SDHAF2', 'ASXL1', 'AMER1', 'RASA1', 'EGR1', 'MST1', 'SOX17', 'RUNX1', 'PIK3R3', 'NCOR1', 'NF1', 'JAK1', 'PTPRD', 'CHEK2', 'CHEK1', 'SMC1A', 'TMEM127', 'STAG1', 'RAD51', 'TCF3', 'STAG2', 'ARID2', 'RAD50', 'RNF43', 'PARP1', 'BLM', 'CUX1', 'RECQL', 'RAD21', 'PTPN2', 'PTPN1', 'SLX4', 'INHA', 'PAX5', 'IRF1', 'TP53', 'HLA-A', 'IRF8', 'CBL', 'TOP1', 'SHQ1', 'PRDM1', 'NSD1', 'ATXN2', 'CREBBP', 'HDAC4', 'SESN2', 'PPP2R1A', 'EPHA7', 'ATM', 'EPHA3', 'POT1', 'SMAD3', 'MOB3B', 'TBX3', 'POLE', 'ATR', 'FANCD2', 'FH', 'BCORL1', 'SOX9', 'IKZF3', 'TSC1', 'TP63', 'MRE11A', 'SDHC', 'BTG1', 'POLD1', 'CIITA', 'SMC3', 'SAMHD1', 'RTEL1', 'ECT2L', 'PIK3R2', 'CRBN', 'FANCC', 'NBN', 'FANCA', 'HLA-B', 'RECQL4', 'DUSP4', 'ERCC2', 'FBXW7', 'TGFBR2', 'TGFBR1', 'MSH3', 'RBM15', 'TET1', 'TET3', 'SESN3', 'MGA', 'LTB', 'FOXL2', 'SH2B3', 'BCOR', 'HIST1H1D', 'ATRX', 'EP300', 'RAD51C', 'RAD51B', 'HIST1H1B', 'TNFAIP3', 'DICER1', 'ARID5B', 'LATS2', 'FOXO1', 'KEAP1', 'EZH2', 'SP140', 'NKX3-1', 'PBRM1', 'PALB2', 'CIC', 'BRCA1', 'DTX1', 'FLCN', 'SPEN', 'CD58', 'ERCC3', 'ERCC4', 'MSH6', 'BCL11B', 'BMPR1A', 'ERF', 'BRCA2', 'NOTCH2', 'EED', 'MITF', 'ELF3', 'SMARCA4', 'BBC3', 'ANKRD11', 'CEBPA', 'BCL2L11', 'AXIN2', 'AXIN1', 'CDK12', 'ESCO2', 'MLH1', 'SDHB', 'MED12', 'HNF1A', 'RYBP', 'ATP6V1B2', 'DNMT3B', 'KMT2B', 'KMT2A', 'DNMT3A', 'NFKBIA', 'TRAF5', 'KMT2D', 'SPOP', 'RBM10', 'P2RY8', 'TP53BP1', 'TSC2', 'KDM6A', 'EPCAM', 'PHOX2B', 'NPM1', 'BCL10', 'LATS1', 'HOXB13', 'ARID3A', 'PTPRT', 'PTPRS', 'INPPL1', 'NOTCH4', 'TET2', 'NOTCH1', 'CASP8', 'NOTCH3', 'GRIN2A', 'MAP2K4', 'WT1', 'BACH2', 'SDHA', 'BAP1', 'PTCH1', 'SDHD'])
    oncogenes = genes - tumorSupressors
    
    cancerTypeMaf = maf[maf['Tumor_Sample_Barcode'].isin(cancerTypeIds)]
    recurrentTumorSupressors, recurrentOncogenes = enumerate_recurrently_mutated_tumor_supressors_and_oncogenes(cancerTypeMaf)
    nonRecurrentTumorSupressors = tumorSupressors - recurrentTumorSupressors
    nonRecurrentOncogenes = oncogenes - recurrentOncogenes
    
    #phasingData = phasingData[phasingData['oncogenic.1'].notnull()]
    phasingCancerType = phasingData[phasingData['Tumor_Sample_Barcode'].isin(cancerTypeIds)]
    
    recurrentTumorSupressorMuts = phasingCancerType[phasingCancerType['Hugo_Symbol'].isin(recurrentTumorSupressors)]
    recurrentOnocgeneMuts = phasingCancerType[phasingCancerType['Hugo_Symbol'].isin(recurrentOncogenes)]
    nonRecurrentTumorSupressorMuts = phasingCancerType[phasingCancerType['Hugo_Symbol'].isin(nonRecurrentTumorSupressors)]
    nonRecurrentOncogenesMuts = phasingCancerType[phasingCancerType['Hugo_Symbol'].isin(nonRecurrentOncogenes)]
    
    cntrRTSMuts = Counter(recurrentTumorSupressorMuts['phase'])
    cntrROMuts = Counter(recurrentOnocgeneMuts['phase'])
    cntrNRTSMuts = Counter(nonRecurrentTumorSupressorMuts['phase'])
    cntrNROMuts = Counter(nonRecurrentOncogenesMuts['phase'])
    
    l =[
        {'cancer_type': cancerType,
        'label': 'cis',
        'geneLabel': 'RecurrentTumorSupressor',
        'frac': 1.0*(cntrRTSMuts['cis'])/recurrentTumorSupressorMuts.shape[0]},
        {'cancer_type': cancerType,
        'label': 'cis',
        'geneLabel': 'NonRecurrentTumorSupressor',
        'frac': 1.0*(cntrNRTSMuts['cis'])/nonRecurrentTumorSupressorMuts.shape[0]},
         {'cancer_type': cancerType,
        'label': 'cis',
        'geneLabel': 'RecurrentOncogene',
        'frac': 1.0*(cntrROMuts['cis'])/recurrentOnocgeneMuts.shape[0]},
        {'cancer_type': cancerType,
        'label': 'cis',
        'geneLabel': 'NonRecurrentOncogene',
        'frac': 1.0*(cntrNROMuts['cis'])/nonRecurrentOncogenesMuts.shape[0]},
        
        {'cancer_type': cancerType,
        'label': 'trans',
        'geneLabel': 'RecurrentTumorSupressor',
        'frac': 1.0*(cntrRTSMuts['trans'] + cntrRTSMuts['trans or separate cells'])/recurrentTumorSupressorMuts.shape[0]},
        {'cancer_type': cancerType,
        'label': 'trans',
        'geneLabel': 'NonRecurrentTumorSupressor',
        'frac': 1.0*(cntrNRTSMuts['trans'] + cntrNRTSMuts['trans or separate cells'])/nonRecurrentTumorSupressorMuts.shape[0]},
        {'cancer_type': cancerType,
        'label': 'trans',
        'geneLabel': 'RecurrentOncogene',
        'frac': 1.0*(cntrROMuts['trans'] + cntrROMuts['trans or separate cells'])/recurrentOnocgeneMuts.shape[0]},
        {'cancer_type': cancerType,
        'label': 'trans',
        'geneLabel': 'NonRecurrentOncogene',
        'frac': 1.0*(cntrNROMuts['trans'] + cntrNROMuts['trans or separate cells'])/nonRecurrentOncogenesMuts.shape[0]}
        ]
    
    return l
    
phasingData = pd.read_table(pathPrefix +'/ifs/res/taylorlab/ang46/data/multiplets/original_data/data_merged_prepped_datafreeze_phased.txt')


print phasingData[(phasingData['Tumor_Sample_Barcode'] == 'P-0015885-T01-IM6') & (phasingData['Hugo_Symbol'] == 'KRAS')]['phase']


print phasingData[(phasingData['Tumor_Sample_Barcode'] == 'P-0012358-T01-IM5')]['purity']
print phasingData[(phasingData['Tumor_Sample_Barcode'] == 'P-0012358-T01-IM5')]['ploidy']
print phasingData[(phasingData['Tumor_Sample_Barcode'] == 'P-0012358-T01-IM5')]['tcn.em.1']
print phasingData[(phasingData['Tumor_Sample_Barcode'] == 'P-0012358-T01-IM5')]['lcn.em.1']
print phasingData[(phasingData['Tumor_Sample_Barcode'] == 'P-0012358-T01-IM5')]['ccf_Mcopies.1']

print Counter(phasingData[(phasingData['Tumor_Sample_Barcode'] == 'P-0012358-T01-IM5')]['phase'])
...
colorectalIds = set(sigs[sigs['cancer_type'] == 'Colorectal Cancer']['Tumor_Sample_Barcode'])
gliomaIds = set(sigs[sigs['cancer_type'] == 'Glioma']['Tumor_Sample_Barcode'])

oneOncMutant = phasingData[(phasingData['oncogenic.1'].notnull()) | (phasingData['oncogenic.2'].notnull())]

oneOncMutant['variant_classification.1']

oneOncMutant.columns.values

endoInfo = oneOncMutant[oneOncMutant['Tumor_Sample_Barcode'].isin(endometrialIds)]
coloInfo = oneOncMutant[oneOncMutant['Tumor_Sample_Barcode'].isin(colorectalIds)]
...
for cancerType in ['Endometrial Cancer', 'Colorectal Cancer', 'Glioma']:
    l = analyze_phasing_amongst_mutations_in_cancer_type(set(sigs[sigs['cancer_type'] == cancerType]['Tumor_Sample_Barcode']),
                                                 maf, phasingData, cancerType)
    x = x + l
df = pd.DataFrame(x)
df['cancerTypeAndGene'] = df.apply(lambda row: row['cancer_type'] + '_' + row['geneLabel'], axis=1)

df.to_csv('~/Desktop/WORK/dataForLocalPlotting/phasingInfo.tsv', sep='\t', index=False)
