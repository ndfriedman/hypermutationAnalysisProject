...
for case in list(allHypermutatedCases):
    if cntr %10 == 0:
...
df.to_csv('/juno/work/taylorlab/friedman/hypermutationAnalysisProj/mutSimulation/expectedMutationTables/allHypermutatorsExpectedGeneMutInfo.tsv', index=False, sep='\t')
